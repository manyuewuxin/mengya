...
export default class Write extends Component {
  ...
  render() {
    return( 
        <React.Fragment>
            <div id="write"></div>
            <Label />
            <button className="editor_submit" onClick={this.submit}>创建文章</button>
        </React.Fragment>
    );
  }
  ...
  componentDidMount() {
    ...
    this.editor.customConfig.lang = {  //title
        '正文': 'p',
        '链接文字': '链接文字',
        '链接': '链接',
        '上传图片': '上传图片',
    ...
    document.querySelector("#write").addEventListener("DOMNodeRemoved",this.remove,false);
  }
} 
