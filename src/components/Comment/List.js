        ...
        const list = this.props.comments.map((comments, index) => {
            ...
            return(
                <li key={key}>
                    ...
                    <CommentAction comment={comment} author={author} user_id={this.props.user_id} index={index}/>
                </li>
                );
        });
        return <ul className="comment_border" onClick={this.props.action}>{list}</ul>;
    }
}
