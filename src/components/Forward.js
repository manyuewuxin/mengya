...
export default class Forward extends Component {
    ...
    openWeibo(e){
        ...
        const url = encodeURIComponent("http://localhost:3000/p/5ba0d6128e392c0e142fc3ee");
        ...
        return (
            <div style={{ position: "absolute", top: position.top, left: position.left }}>
                <div className="forward">
                    <button onClick={this.openWeibo}><i className="icon_weibo"></i><span>新浪微博</span></button>
                    <button onClick={this.openWeixin}><i className="icon_weixin"></i><span>腾讯微信</span></button>
                </div>
            </div>
        );
    } 
